  ...
  Widget build(BuildContext context) {
    ...
    Column(
            ...
            children: [
                    ...
                    child: Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                       ...
                       children: [
                         ...
                         Text(
                          "${s.getOccupantProfileResponse.value.data?.firstName??""}",
                        ...
                        // Email
                         Text(
                           ...
                           overflow: TextOverflow.ellipsis,
                            "${s.getOccupantProfileResponse.value.data?.email??""}",
              ...
              const SizedBox(height: 20),
              // Details Section
              buildInfoTile("Unit/Shop no", s.getOccupantProfileResponse.value.data?.shop??""),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    Preference.shared.remove(Preference.USER_ID);
